...
{
    public class StockMoventAppService : AccountancyAppService, IStockMoventAppService
    {
        private readonly IInvoiceDetailRepository _invoiceDetailRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public StockMoventAppService(IInvoiceDetailRepository invoiceDetailRepository, IUnitOfWorkManager unitOfWorkManager)
        {
            _invoiceDetailRepository = invoiceDetailRepository;
            _unitOfWorkManager = unitOfWorkManager;
        }
        public async Task<PagedResultDto<ListStockMoventDto>> GetListAsync(StockMoventListParameterDto input)
        {
