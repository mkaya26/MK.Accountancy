...
{
    public class UpdateBankDepertmentDtoValidator : AbstractValidator<UpdateBankDepartmentDto>
    {
        public UpdateBankDepertmentDtoValidator(IStringLocalizer<AccountancyResource> localizer)
        {
            RuleFor(x => x.Code)
                .NotEmpty()
