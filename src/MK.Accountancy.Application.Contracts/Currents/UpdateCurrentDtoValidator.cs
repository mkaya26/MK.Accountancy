...
{
    public class UpdateCurrentDtoValidator : AbstractValidator<UpdateCurrentDto>
    {
        public UpdateCurrentDtoValidator(IStringLocalizer<AccountancyResource> localizer)
        {
            RuleFor(x => x.Code)
                .NotEmpty()
