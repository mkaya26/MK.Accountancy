...
{
    public class UpdateSpecialCodeDtoValidator : AbstractValidator<UpdateSpecialCodeDto>
    {
        public UpdateSpecialCodeDtoValidator(IStringLocalizer<AccountancyResource> localizer)
        {
            RuleFor(x => x.Code)
                .NotEmpty()
